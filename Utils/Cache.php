<?php
    ...
    class Cache
    {
        ...
        public function save($object, $idx=null, $tags=null)
        {
            ...
            if (isset($this->_objects[$idx])) {
                throw new \Thin\Exception('Object already exists in registry (' . $idx . '). Old object class: ' . get_class($this->_objects[$idx]) . ', new object class: ' . get_class($object));
            }
        ...
        public function reference($refName, $idx)
        {
            ...
            if (isset($this->_references[$refName])) {
                throw new \Thin\Exception('The reference already exists: '.$refName.'. New index: '.$idx.', old index: '.$this->_references[$refName]);
            }
