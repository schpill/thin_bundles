<?php
    ...
    class Object implements ArrayAccess
    {
        ...
        */
        ...
        protected function __toXml(array $arrAttributes = [], $rootName = 'item', $addOpenTag=false, $addCdata=true)
        {
            ...
            foreach ($arrData as $fieldName => $fieldValue) {
                if ($addCdata === true) {
                    ...
                    $fieldValue = $this->xmlentities($xmlModel, $fieldValue);
                }
        ...
        public function xmlentities($xml, $value = null)
        {
            if (is_null($value)) {
                $value = $xml;
            }
        ...
        public function __call($method, $args)
        {
            ...
            throw new \Thin\Exception("Invalid method " . get_class($this) . "::" . $method . "(" . print_r($args, 1) . ")");
        }
        ...
        protected function _underscore($name)
        {
            ...
            $result = Inflector::lower(preg_replace('/(.)([A-Z])/', "$1_$2", $name));
