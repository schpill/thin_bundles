<?php
    ...
    class Crud
    {
            ...
            foreach ($data as $item) {
                ...
                if (count($many)) {
                    ...
                    foreach ($many as $rel) {
                        ...
                        $html .= '<li><a class="btn btn-primary" target="_blank" href="' . urlAction('many') . '/table/' . $rel . '/foreign/' . $this->model->table . '_id/id/' . $id . '"><i class="fa fa-chain"></i> ' . $nameRel . '</a></li>';
                    }
        ...
        private function options($id, $plus = '')
        {
            ...
            $options .= '<td style="text-align: center;"><ul class="list-inline"><li><a rel="tooltip" title="afficher" class="btn btn-xs btn-info" href="' . urlAction('read') . '/table/' . $this->model->table . '/id/' . $id . '"><i class="fa fa-file"></i></a></li>';
            ...
            $options .= '<li><a rel="tooltip" title="supprimer" class="btn btn-xs btn-danger" href="#" onclick="if (confirm(\'Confirmez-vous la suppression de cet élément ?\')) document.location.href = \'' . urlAction('delete') . '/table/' . $this->model->table . '/id/' . $id . '\'; return false;"><i class="fa fa-trash-o"></i></a></li>' . $plus . '</ul></td>';
